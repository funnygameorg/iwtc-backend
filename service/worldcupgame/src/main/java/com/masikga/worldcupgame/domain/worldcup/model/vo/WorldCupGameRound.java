package com.masikga.worldcupgame.domain.worldcup.model.vo;

import com.masikga.worldcupgame.domain.worldcup.exception.NotSupportedGameRoundExceptionMember;
...
public enum WorldCupGameRound {
    ...
    public static WorldCupGameRound getRoundFromValue(int value) {
        return Arrays.stream(WorldCupGameRound.values())
                ...
                .findFirst()
                .orElseThrow(() -> new NotSupportedGameRoundExceptionMember(value + "는 해당 게임에서 플레이 불가 라운드입니다."));
    }
}
