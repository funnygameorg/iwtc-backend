...
import com.masikga.worldcupgame.domain.worldcup.repository.WorldCupGameCustomRepository;
import com.masikga.worldcupgame.domain.worldcup.repository.impl.mapper.WorldCupGameMapper;
...
public class WorldCupGameRepositoryImpl implements WorldCupGameCustomRepository {
    ...
    private final WorldCupGameMapper worldCupGameMapper;
    ...
    @Override
    public Boolean existsWorldCupGameV2(Long worldCupGameId) {
        return worldCupGameMapper.existsWorldCupGame(worldCupGameId);
    }

    @Override
    public GetAvailableGameRoundsProjection getAvailableGameRoundsV2(Long worldCupGameId) {
        return worldCupGameMapper.getAvailableGameRounds(worldCupGameId);
    }
     ...
     */
    @Override
    public List<GetDividedWorldCupGameContentsProjection> getDividedWorldCupGameContentsV2(
            Long worldCupId,
            int wantedContentsSize,
            List<Long> alreadyPlayedContentsIds
    ) {
        return worldCupGameMapper.getDividedWorldCupGameContents(
                worldCupId,
                wantedContentsSize,
