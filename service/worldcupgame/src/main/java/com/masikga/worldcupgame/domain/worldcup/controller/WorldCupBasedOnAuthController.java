...
public class WorldCupBasedOnAuthController {
    ...
    @ResponseStatus(OK)
    public com.masikga.worldcupgame.common.web.RestApiResponse<GetWorldCupResponse> getWorldCup(
            @PathVariable long worldCupId,

            @Parameter(hidden = true)
            @CustomAuthentication
            Optional<com.masikga.worldcupgame.common.web.memberresolver.MemberDto> memberDto
    ) {

        var response = worldCupBasedOnAuthService.getMyWorldCup(worldCupId, memberDto.get().getId());
        return new com.masikga.worldcupgame.common.web.RestApiResponse(1, "자신의 월드컵 조회", response);
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            responseCode = "204",
                            description = "월드컵 수정",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.masikga.worldcupgame.common.web.RestApiResponse.class))
                    ),
                    @ApiResponse(
                            responseCode = "400",
    ...
    public com.masikga.worldcupgame.common.web.RestApiResponse putMyWorldCup(
            @Valid
            @RequestBody
        ...
        return new com.masikga.worldcupgame.common.web.RestApiResponse(1, "게임 수정", null);
    ...
    @PostMapping
    public com.masikga.worldcupgame.common.web.RestApiResponse<Long> createMyWorldCup(
            @Valid
            @RequestBody
            CreateWorldCupRequest request,
        ...
        return new com.masikga.worldcupgame.common.web.RestApiResponse(1, "게임 생성", worldCupId);
    ...
    public com.masikga.worldcupgame.common.web.RestApiResponse<Long> deleteMyWorldCup(
        ...
        var deletedContentsId = worldCupBasedOnAuthService.deleteMyWorldCup(worldCupId,
                memberDto.get().getId());
        return new com.masikga.worldcupgame.common.web.RestApiResponse(1, "게임 삭제", deletedContentsId);
    ...
    @ResponseStatus(OK)
    @GetMapping
    public com.masikga.worldcupgame.common.web.RestApiResponse<List<GetMyWorldCupResponse>> getMyWorldCups(
            @Parameter(hidden = true)
            @CustomAuthentication
