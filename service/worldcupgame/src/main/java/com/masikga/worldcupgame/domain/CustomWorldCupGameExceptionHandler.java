package com.masikga.worldcupgame.domain;
...
public class CustomWorldCupGameExceptionHandler {
    ...
    @ExceptionHandler(WorldCupBaseException.class)
    ResponseEntity<CustomErrorResponse> handledException(WorldCupBaseException ex) {
