...
import static com.masikga.worldcupgame.domain.worldcup.model.vo.WorldCupGameRound.ROUND_32;
...
public class WorldCupGameRepositoryTest implements IntegrationBaseTest {
    ...
    public class getDividedWorldCupGameContents {
        ...
        public void success1() {
            ...
            // when
            List<GetDividedWorldCupGameContentsProjection> result = worldCupGameRepository.getDividedWorldCupGameContentsV2(
                    1L,
                    8,
                    List.of()
            );
