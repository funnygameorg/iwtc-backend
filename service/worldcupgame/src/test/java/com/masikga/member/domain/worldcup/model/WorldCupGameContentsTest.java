package com.masikga.member.domain.worldcup.model;

import com.masikga.worldcupgame.common.error.exception.NotNullArgumentExceptionMember;
...
public class WorldCupGameContentsTest {
    ...
    class UpdateByCommonManage {
        ...
        public void fail1() {
            ...
            // when & then
            assertThrows(
                    NotNullArgumentExceptionMember.class,
                    () -> contents.updateByCommonManage(
                            "새로운 정적 파일",
                            null,
                            null,
