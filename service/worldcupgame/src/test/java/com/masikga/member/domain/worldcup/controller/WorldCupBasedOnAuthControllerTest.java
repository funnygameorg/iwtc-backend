package com.masikga.member.domain.worldcup.controller;
...
import com.masikga.worldcupgame.domain.worldcup.controller.request.CreateWorldCupContentsRequest.CreateMediaFileRequest;
...
public class WorldCupBasedOnAuthControllerTest extends WebMvcBaseTest {
    protected static final String WORLD_CUPS_ROOT_PATH = ROOT_PATH + "/me/game-manage";
    protected static final String WORLD_CUP_CONTENTS_ROOT_PATH = ROOT_PATH + "/me/game-contents-manage";

    private final static String CREATE_MY_WORLD_CUP = WORLD_CUPS_ROOT_PATH + "/world-cups";

    private final static String CREATE_MY_WORLD_CUP_CONTENTS = WORLD_CUP_CONTENTS_ROOT_PATH + "/world-cups/{worldCupId}/contents";
    private final static String UPDATE_MY_WORLD_CUP_CONTENTS = WORLD_CUP_CONTENTS_ROOT_PATH + "/world-cups/{worldCupId}/contents/{contentsId}";
    private final static String GET_MY_GAME_CONTENTS_API = WORLD_CUP_CONTENTS_ROOT_PATH + "/world-cups/{worldCupId}/contents";
    ...
    public class putWorldCupContents {
        ...
        public void success() throws Exception {
            ...
            mockMvc.perform(
                            put(UPDATE_MY_WORLD_CUP_CONTENTS, 1, 1)
