...
import com.masikga.member.common.web.RestApiResponse;
...
import com.masikga.member.controller.response.GetMySummaryResponse;
...
public class MemberController {
    ...
    public RestApiResponse getMySummary(
        ...
        MemberDto memberDto = optionalMemberDto.orElseThrow(NotFoundMemberExceptionMember::new);
    ...
    @GetMapping("/{memberId}")
    @ResponseStatus(OK)
    public RestApiResponse<GetMemberResponse> getMember(@PathVariable Long memberId) {

        return new RestApiResponse(1, "정보 조회 성공", memberService.findById(memberId));
