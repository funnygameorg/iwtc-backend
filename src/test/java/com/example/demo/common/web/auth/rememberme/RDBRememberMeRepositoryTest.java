...
public class RDBRememberMeRepositoryTest implements IntegrationBaseTest {
	...
	class isRemember {
		...
		@Test
		@DisplayName(SUCCESS_PREFIX + "로그인하지 않은 사용자는 유지상태가 아님")
		...
		@Test
		@DisplayName(SUCCESS_PREFIX + "만료시간과 현재시간이 동일, 토큰 시간 만료")
		...
		@Test
		@DisplayName(SUCCESS_PREFIX + "만료시간 1초 차이로 토큰 유효")
		...
		@Test
		@DisplayName(SUCCESS_PREFIX + "만료시간 1초 차이로 토큰 만료")
	...
	class containBlacklistedAccessToken {
		...
		@Test
		@DisplayName(SUCCESS_PREFIX + "블랙 리스트 엑세스 토큰이 존재하지 않는다.")
		public void success2() {
